                                ...
                                <div class="col-md-5 ">
                                    <aside class="profile-nav ">
                                        <div class="user-heading round">
                                            <div class="row">
                                                <div class="col-5">
                                                    <?php if (!empty($teacher->img_url)) { ?>
                                                        <a href="#">
                                                            <div class="m-b-25"> <img src="<?= $teacher->img_url ?>" class="img-radius" alt="User-Profile-Image" style="max-width: 200px; width: 150px; border-radius: 50%;"> </div>
                                                        </a>
                                                    <?php } ?>
                                                ...
                                                <div class="col-6">
                                                    <h5><?php echo $teacher->name ?>
                                                        </b></h5>
                                                    <h6 class="text-dark"><b>CRP: | </b><b class="text-bold-700"> <?= $teacher->crp ?></b></h6>
                                            ...
                                            <div class="card-block">
                                                ...
                                                ?>
                                                <p style="margin: 30px;  margin: auto;  text-align: justify;"><?= mb_substr($teacher->profile, 0, 300, 'UTF-8'); ?>
